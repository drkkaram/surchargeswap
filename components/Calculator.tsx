  ...
  return (
    <div className="space-y-8">
      ...
      <form
        ...
        className="space-y-6 rounded-md border border-[#E5E5E0] bg-[#F5F5F0] p-7 sm:p-10"
      >
        {/* Field 1: Monthly card revenue */}
        <div>
          <label
            htmlFor="monthlyCardRevenue"
            className="block text-sm font-medium text-[#0B1C3D]"
          >
            Monthly card sales
          </label>
          <p className="mt-0.5 text-xs text-[#737373]">
            Total amount you take on card each month — not cash. Check your processor&apos;s app under &ldquo;Reports&rdquo; or &ldquo;Transactions&rdquo;, or look at last month&apos;s merchant fee invoice. The total card volume is usually printed right at the top.
          </p>
          <div className="relative mt-2">
            ...
            <input
              ...
              className="w-full rounded-md border border-[#E5E5E0] bg-white py-3 pl-7 pr-4 text-base text-[#0B1C3D] focus:border-[#E8651A] focus:outline-none focus:ring-1 focus:ring-[#E8651A]/30"
            />
          </div>
        ...
        <div>
          <label
            ...
            className="block text-sm font-medium text-[#0B1C3D]"
          >
            Your bank&apos;s fee per transaction (%)
          </label>
          <p className="mt-0.5 text-xs text-[#737373]">
            The cut your payment provider takes on every card sale — not what you charge customers. Usually between 1.3% and 1.9%.
            Find it on your monthly merchant statement — it&apos;ll say &ldquo;MSF rate&rdquo;, &ldquo;blended rate&rdquo;, or &ldquo;service fee %&rdquo;.
            Can&apos;t find it? Use <strong>1.7%</strong> — it&apos;s a safe average.
          </p>
          <div className="relative mt-2">
            <input
              id="currentMsfPct"
              ...
              className="w-full rounded-md border border-[#E5E5E0] bg-white py-3 pl-3 pr-8 text-base text-[#0B1C3D] focus:border-[#E8651A] focus:outline-none focus:ring-1 focus:ring-[#E8651A]/30"
            />
        ...
        {/* Field 3: Surcharge rate — moved out of accordion, it's core to the calculation */}
        <div>
          <label
            htmlFor="currentSurchargePct"
            className="block text-sm font-medium text-[#0B1C3D]"
          >
            Surcharge you currently add to customer bills (%)
          </label>
          <p className="mt-0.5 text-xs text-[#737373]">
            The extra % you currently charge customers when they pay by card. Usually 1–1.5%. This is the revenue you&apos;ll lose when the ban kicks in — it&apos;s the most important number in this calculator.
          </p>
          <div className="relative mt-2">
            <input
        ...
        <div className="border-t border-[#E5E5E0] pt-4">
          <button
            ...
            className="flex w-full items-center gap-2 text-sm font-medium text-[#6B7280] transition-colors hover:text-[#0B1C3D]"
          >
            <svg
            ...
            Adjust your card types
            <span className="text-xs font-normal text-[#737373]">
              (optional — uses café defaults if skipped)
            </span>
          </button>
          ...
          {advancedOpen && (
            <div className="mt-4 space-y-5">
              ...
              <div
                ref={cardMixRef}
                className={`space-y-4 rounded-md p-5 transition-colors ${
                  mixError
                    ...
                    <button
                      ...
                      className={`rounded-md px-3.5 py-1.5 text-xs font-medium transition-colors ${
                        activePreset === preset.label
                          ...
                          : "border border-[#E5E5E0] bg-white text-[#6B7280] hover:border-[#E8651A] hover:text-[#E8651A]"
                      }`}
                    >
                      {preset.label}
                    </button>
                    ...
                    <div key={field.name}>
                      ...
                      <div className="relative mt-1">
                        <input
                          ...
                          className="w-full rounded-md border border-[#E5E5E0] bg-white py-3 pl-3 pr-8 text-sm text-[#0B1C3D] focus:border-[#E8651A] focus:outline-none focus:ring-1 focus:ring-[#E8651A]/30"
                        />
        ...
        <button
          ...
          className="w-full rounded-md bg-[#E8651A] py-3.5 text-base font-semibold text-white shadow-sm transition-colors hover:bg-[#C4541A] disabled:opacity-50"
        >
      ...
      {result && (
        ...
        >
          ...
          {/* Share section */}
          <div className="flex flex-col gap-2 border-t border-[#E5E5E0] pt-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-sm font-semibold text-[#0B1C3D]">Share with your accountant</p>
            ...
            <button
              ...
              className="inline-flex shrink-0 items-center gap-2 rounded-md border border-[#E5E5E0] bg-white px-4 py-2.5 text-sm font-medium text-[#0B1C3D] transition-colors hover:bg-[#F5F5F0] hover:border-[#CBD5E1]"
            >
              {copied ? (
                <>
